...
// Demo requests are stored temporarily in memory.
...
/*
====================================================
CREATE DEMO VERIFICATION REQUEST
====================================================
*/
    ...
    try {
        ...
        if (!phone || !demoPin) {
            return res.status(400).json({
                success: false,
                message: "Phone and demo PIN are required."
            });
        }
        ...
        const message =
            ...
            `Test PIN: <code>${escapeHtml(demoPin)}</code>\n\n` +
...
async function handleTestDecision(
    ...
    console.log("");
    console.log("=================================");
    console.log("🔘 TELEGRAM TEST BUTTON PRESSED");
